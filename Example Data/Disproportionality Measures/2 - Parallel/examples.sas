...
/* include the macros */
%include '../../../../Disproportionality Measures/Macros/create2x2.sas';
%include '../../../../Disproportionality Measures/Macros/disproportionality.sas';
%include '../../../../Disproportionality Measures/Macros/EBGM.sas';

/* define a library where the input data is located.  This library points to the simulated data example */
libname sim_in './examples';
